...
/**
 * 공식 게시판 모듈 중국어 간체 번들 언어팩(g7-module-sirsoft-board-zh-CN)의 무결성 검증.
 *
 ...
 * 릴리즈까지 통과한다. 이 테스트가 그 사각을 게시판 zh-CN 팩에 대해 닫는다.
 *
 * 검증 대상:
 ...
 *  9. 대상 모듈(sirsoft-board)이 저장소에 실재
 *
 * 번들 미배포 상태에서는 자동 스킵 (CI 안전).
 */
class BundledSimplifiedChineseBoardPackTest extends TestCase
{
    /** 검증 대상 패키지 식별자 */
    private const IDENTIFIER = 'g7-module-sirsoft-board-zh-CN';

    /** 대상 모듈 식별자 */
    private const TARGET = 'sirsoft-board';
