...
/**
 * g7-plugin-sirsoft-pay_nhnkcp-zh-CN 언어팩 정합성 검사기 진입점 (standalone).
 *
 ...
 *
 * 실행:
 *   php tests/Translations/zh-CN-pay-nhnkcp-parity-check.php [--verbose] [--style]
 *
 * 종료 코드: 0 = 통과, 1 = 위반 발견.
 */
...
exit(zhcnRunPluginEntrypoint('sirsoft-pay_nhnkcp', $intentional, $argv));
